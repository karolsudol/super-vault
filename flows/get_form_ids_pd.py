...
def supervault_flow():
    ...
    # Format data for pandas DataFrames
    formatted_data = format_supervault_data(contract_info, vault_address)
    
    # Return both DataFrames
    return {
        'whitelist_df': formatted_data['whitelist'],
        'metrics_df': formatted_data['metrics'],
        'contract_info': contract_info
    }

if __name__ == "__main__":
    result = supervault_flow()
    print("\nWhitelist DataFrame:")
    print(result['whitelist_df'])
    print("\nMetrics DataFrame:")
